...
import crudjsfhibernateproject.HibernateUtil;
...
public class DaoGeneric<E> {
	...
	public void deletarPoId(E entidade) throws Exception{
		...
		transaction.begin();//inicia a transação no banco de dados
		
		entityManager
				.createNativeQuery(
						"delete from " + entidade.getClass().getSimpleName().toLowerCase() + " where id =" + id)
				.executeUpdate(); // Monta a query e faz delete no banco de dados 
